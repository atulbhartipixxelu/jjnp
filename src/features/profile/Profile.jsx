...
export default function Profile() {
  ...
  return (
    <div className="h-auto">
      ...
      <div className="loop-statices m-4 lg:my-16 lg:mx-8 " ref={addtoRefs}>
            ...
            <Card className=" rounded-lg bg-white shadow-none ">
              <div className="flex items-center justify-center flex-wrap gap-10">
                {[
                  ...
                  <div key={key}>
                    <div
                      className="submission-crop hover:text-gray-900 cursor-pointer transition duration-300 ease-in-out w-80 items-center justify-center text-center rounded-md cursor-pointer transition duration-300 ease-in-out"
